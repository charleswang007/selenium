# source: https://hackmd.io/@FortesHuang/S1V6jrvet
...
basedir = "C:/Users/charleswang/GitHub/selenium"
if __name__ == '__main__':
    test_suite = unittest.defaultTestLoader.discover(basedir, pattern='*.py')
    result = BeautifulReport(test_suite)
    result.report(filename='report',description='我的第一個測試', log_path='C:/Users/charleswang/GitHub/selenium')